export default class Validator {
     ...
     */
    static date(date) {
        return /^([0-9]{4}\-([0-3]{1}[0-9]{1}|[0-1]{1}[0-9]{1})\-([0-3]{1}[0-9]{1}|[0-1]{1}[0-9]{1})|[0-9]{4}\.([0-3]{1}[0-9]{1}|[0-1]{1}[0-9]{1})\.([0-3]{1}[0-9]{1}|[0-1]{1}[0-9]{1})|[0-9]{4}\/([0-3]{1}[0-9]{1}|[0-1]{1}[0-9]{1})\/([0-3]{1}[0-9]{1}|[0-1]{1}[0-9]{1}))$/.test(date);
    }
}
